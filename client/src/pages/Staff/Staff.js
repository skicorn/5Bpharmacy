...
function Staff() {
    ...
    const Filter = (event) => {
        ...
        if (keyword.length > 0) {
            setRecords(data.filter(f => f.name.toLowerCase().includes(keyword)));
        } else {
            setRecords(data); 
        }
    };
                ...
                <div className="staff-content">
                    ...
                    <div className="multi-nav">
                        <div className="add-nav-search-1">
                            ...
                            <div className="input-search"><input className="input-s" placeholder="Search ..." onChange={Filter} /></div>
                        </div>
                    ...
                    <div className="staff-table" >
                        <table class="table custom-table">
                            ...
                            <tbody>
                                 ...
                                 {records.map((staff,index)=> {
                                        return <tr key={index}> 
                                        <td><img src={staff.id} alt="Image" width="100" /></td>
                                        <td>{staff.name}</td>
                                        <td>{staff.phone}</td>
                                        <td>{staff.email}</td>
                                        <td>{staff.salary}</td>
